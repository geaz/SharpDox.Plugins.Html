...
{ 
	...
	var namespaceNavTemplate = new NamespaceNavTemplate { Namespace = sdNamespace, Strings = Strings }; 
            ...
            #line 1 "D:\Github\SharpDox.Plugins.Html\Templates\Nav\ApiNavTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(string.Format("<li><a href=\"#namespace/{0}.html\" id=\"nav-{0}\"><i class=\"icon-chevron-sign-right\"></i> {1}</a>{2}</li>", sdNamespace.Guid, sdNamespace.Fullname, namespaceNavTemplate.TransformText())));
