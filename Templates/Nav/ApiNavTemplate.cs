...
#line hidden
	...
	{ 
		...
		var namespaceNavTemplate = new NamespaceNavTemplate { Namespace = sdNamespace, Strings = Strings }; 
            ...
            #line 1 "D:\Github\SharpDox.Plugins.Html\Templates\Nav\ApiNavTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(string.Format("<li data-url=\"{0}\" data-type=\"namespace\"><a href=\"#{0}\" id=\"nav-{0}\"><i class=\"icon-chevron-sign-right\"></i> <p>{1}</p></a>{2}</li>", sdNamespace.Fullname, sdNamespace.Fullname, namespaceNavTemplate.TransformText())));
