...
namespace SharpDox.Plugins.Html.Templates.Nav
{
    ...
    #line 1 "C:\Users\ZP620933\Downloads\SharpDox.Plugins.Html-dev\Templates\Nav\ApiNavTemplate.tt"
...
#line hidden
	...
	if(Repository.Articles.Count > 0) { 
            ...
            #line default
            #line hidden
            this.Write("\n\t\t<ul class=\"navigation-sub\">\n\t\t<li class=\"navigation-back\"><a href=\"#\"><i class" +
                    "=\"icon-chevron-sign-left\"></i> <p>");
	...
	{ 
		...
		var namespaceNavTemplate = new NamespaceNavTemplate { Namespace = sdNamespace, Strings = Strings }; 
            ...
            #line 1 "C:\Users\ZP620933\Downloads\SharpDox.Plugins.Html-dev\Templates\Nav\ApiNavTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(string.Format("<li data-url=\"{0}\" data-type=\"namespace\"><a href=\"#{0}\" id=\"nav-{0}\"><i class=\"icon-chevron-sign-right\"></i> <p>{1}</p></a>{2}</li>", sdNamespace.Guid, sdNamespace.Fullname, namespaceNavTemplate.TransformText())));
