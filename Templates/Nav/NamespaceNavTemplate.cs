  ...
  for (int i = 0; i < Namespace.Types.Count; i++)
	{ 
		...
		var typeNavTemplate = new TypeNavTemplate { SDType = sdType, Strings = Strings }; 
            ...
            #line 1 "C:\Users\ZP620933\Downloads\SharpDox.Plugins.Html-dev\Templates\Nav\NamespaceNavTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(string.Format("<li data-url=\"{0}\" data-type=\"type\"><a href=\"#{0}\"><i class=\"icon-chevron-sign-right\"></i> <p>{1}</p></a> {2}</li>", sdType.Guid, sdType.Name, typeNavTemplate.TransformText())));
