...
#line hidden
 ...
 var articleNavTemplate = new ArticleNavTemplate { Article = article, Repository = Repository, Strings = Strings }; 
            ...
            #line 1 "D:\Github\SharpDox.Plugins.Html\Templates\Nav\ArticleNavTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(string.Format("<li data-url=\"{0}\" data-type=\"article\"><a href=\"#{0}\" id=\"nav-{0}\"><i class=\"icon-link\"></i> <p>{1}</p></a>{2}</li>", article.Guid, article.Title, articleNavTemplate.TransformText())));
